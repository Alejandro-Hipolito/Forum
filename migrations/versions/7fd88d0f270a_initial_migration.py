...
Revision ID: 7fd88d0f270a
Revises: 
Create Date: 2024-02-06 19:16:34.201976
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('BASIC', 'PREMIUM', 'MOD', 'SUPERUSER', name='userrole'), nullable=True),
